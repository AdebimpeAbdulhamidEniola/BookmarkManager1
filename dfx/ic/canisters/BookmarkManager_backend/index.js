...
import { idlFactory } from './BookmarkManager_backend.did.js';
export { idlFactory } from './BookmarkManager_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BOOKMARKMANAGER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./BookmarkManager_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the BookmarkManager_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./BookmarkManager_backend.did.js")._SERVICE>}
 */
export const BookmarkManager_backend = createActor(canisterId);
